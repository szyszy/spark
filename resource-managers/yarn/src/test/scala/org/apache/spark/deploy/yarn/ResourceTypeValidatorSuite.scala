...
class ResourceTypeValidatorSuite extends SparkFunSuite with Matchers with BeforeAndAfterAll {
  ...
  private def getExpectedErrorMessage(
    ...
    s"Error: $resource cannot be requested with config $newConfig, " +
        s"please use config $oldConfig instead!"
  }
  ...
  test("Memory defined with new config for executor") {
    ...
    thrown.getMessage should startWith(getExpectedErrorMessage("memory", "spark.executor.memory",
  ...
  test("Cores defined with new config for executor") {
    ...
    thrown.getMessage should startWith (getExpectedErrorMessage("cores", "spark.executor.cores",
  ...
  test("Memory defined with new config, client mode") {
    ...
    thrown.getMessage should startWith (getExpectedErrorMessage("memory", "spark.yarn.am.memory",
  ...
  test("Memory defined with new config for driver, cluster mode") {
    ...
    thrown.getMessage should startWith (getExpectedErrorMessage("memory", "spark.driver.memory",
  ...
  test("Cores defined with new config, client mode") {
    ...
    thrown.getMessage should startWith (getExpectedErrorMessage("cores", "spark.yarn.am.cores",
  ...
  test("Cores defined with new config for driver, cluster mode") {
    ...
    thrown.getMessage should startWith (getExpectedErrorMessage("cores", "spark.driver.cores",
  ...
  test("various duplicated definitions") {
    ...
    thrown.getMessage should (
      include(getExpectedErrorMessage("memory", "spark.executor.memory",
        "spark.yarn.executor.resource.memory")) and
        include(getExpectedErrorMessage("memory", "spark.yarn.am.memory",
          "spark.yarn.am.resource.memory")) and
        include(getExpectedErrorMessage("memory", "spark.driver.memory",
          "spark.yarn.driver.resource.memory"))
      )
  }
